...
def test_is_math_question():
    ...
    assert parser._is_math_question({"question": "2 + 2", "answer": 4})
    assert not parser._is_math_question({"question": "What is the capital of France?", "answer": "Paris"})
    assert not parser._is_math_question({"question": "2 ++ 2", "answer": "4"})